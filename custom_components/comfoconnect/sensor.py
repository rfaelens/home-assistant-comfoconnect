...
from aiocomfoconnect.sensors import (
    ...
    SENSOR_GHE_TEMPERATURE_OUTDOOR,
    SENSOR_GHE_TEMPERATURE_GROUND,
    SENSOR_GHE_PUMP_STATE,
    SENSOR_GHE_PRESENT,
    SENSORS,
...
SENSOR_TYPES = (
    ...
    ComfoconnectSensorEntityDescription(
        key=SENSOR_GHE_TEMPERATURE_OUTDOOR,
        device_class=SensorDeviceClass.TEMPERATURE,
        state_class=SensorStateClass.MEASUREMENT,
        name="Outside temperature (ComfoFond)",
        native_unit_of_measurement=TEMP_CELSIUS,
        ccb_sensor=SENSORS.get(SENSOR_GHE_TEMPERATURE_OUTDOOR),
    ),
    ComfoconnectSensorEntityDescription(
        key=SENSOR_GHE_TEMPERATURE_GROUND,
        device_class=SensorDeviceClass.TEMPERATURE,
        state_class=SensorStateClass.MEASUREMENT,
        name="Ground temperature (ComfoFond)",
        native_unit_of_measurement=TEMP_CELSIUS,
        ccb_sensor=SENSORS.get(SENSOR_GHE_TEMPERATURE_GROUND),
    ),
    ComfoconnectSensorEntityDescription(
    ...
    ComfoconnectSensorEntityDescription(
        key=SENSOR_GHE_PUMP_STATE,
        state_class=SensorStateClass.MEASUREMENT,
        name="ComfoFond pump duty",
        native_unit_of_measurement=PERCENTAGE,
        icon="mdi:pump",
        ccb_sensor=SENSORS.get(SENSOR_GHE_PUMP_STATE),
        entity_registry_enabled_default=False,
        entity_category=EntityCategory.DIAGNOSTIC,
        throttle=True,
    ),
